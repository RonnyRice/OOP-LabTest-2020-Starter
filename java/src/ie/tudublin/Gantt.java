...
{	
	...
	float namesPart = 150; // area of width to where the lables are put into
	...
	public void mouseDragged()
	{
		if (whichTask != -1)
		{
			int month = (int)map(mouseX, namesPart, width - border, 1, maxMonths); // position of the mouse relative to the month when dragged
